    ...
    <div className={styles.frameParent}>
      <header className={styles.splitterParent}>
        ...
        <div className={styles.simpleButtonParent}>
          ...
          <a href="#"><div className={styles.logIn}>Log In</div></a>
          ...
          <div className={styles.simpleButton1}>
            < a href="#"><div className={styles.getStarted}>Get Started</div></a>
      ...
      <div className={styles.frameGroup}>
        ...
        <div className={styles.ctaButtonParent}>
          <button className={styles.ctaButton}>
            <a href="#"><div className={styles.bookADemo}>Book A Demo</div></a>
          </button>
